...
public class PageRankTaxation {
    ...
    public static void main(String[] args) {
        if (args.length < 3) {
            System.err.println("Usage: TaxationPageRank <path_to_links_file> <path_to_titles_file> <output_directory>");
            System.exit(1);
        }
        ...
        //Applying taxation
        ranks = ranks.reduceByKey(Double::sum).mapValues(r -> Beta*r + (1-Beta));
